// deck.js
// Purpose: card id constants, ranges and utility functions for a standard 52-card deck.

// Card ids: 0..51, where 0..12 = Diamonds, 13..25 = Clubs, 26..38 = Hearts, 39..51 = Spades

// Rank constants (as numeric ids). Use exported helper functions to work with these ids.
...
const DIAMONDS_RANGE = { start: 0, end: 12 };
const CLUBS_RANGE = { start: 13, end: 25 };
const HEARTS_RANGE = { start: 26, end: 38 };
const SPADES_RANGE = { start: 39, end: 51 };
